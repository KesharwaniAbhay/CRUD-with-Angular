...
import "./chunk-AXOSKZ4X.js";
import {
  Overlay,
  OverlayModule
} from "./chunk-YRQL746K.js";
import {
  TimesIcon
...
function MultiSelect_ng_container_7_ng_container_2_div_1_ng_container_4_TimesCircleIcon_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const item_r4 = ɵɵnextContext(2).$implicit;
    const ctx_r1 = ɵɵnextContext(3);
    ɵɵproperty("ngClass", ɵɵpureFunction1(5, _c17, ctx_r1.isOptionDisabled(item_r4)))("styleClass", "p-multiselect-token-icon");
...
var MultiSelectItem = class _MultiSelectItem {
  ...
  static ɵfac = function MultiSelectItem_Factory(t) {
    return new (t || _MultiSelectItem)(ɵɵdirectiveInject(PrimeNGConfig));
  };
...
var MultiSelect = class _MultiSelect {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    inputs: {
      ...
      selectionLimit: [InputFlags.HasDecoratorInputTransform, "selectionLimit", "selectionLimit", (value) => numberAttribute(value, null)],
