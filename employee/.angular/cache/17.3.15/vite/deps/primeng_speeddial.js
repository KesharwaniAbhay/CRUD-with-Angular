...
var SpeedDial = class _SpeedDial {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    inputs: {
      ...
      className: "className",
      direction: "direction",
      transitionDelay: [InputFlags.HasDecoratorInputTransform, "transitionDelay", "transitionDelay", numberAttribute],
      type: "type",
      radius: [InputFlags.HasDecoratorInputTransform, "radius", "radius", numberAttribute],
      mask: [InputFlags.HasDecoratorInputTransform, "mask", "mask", booleanAttribute],
      disabled: [InputFlags.HasDecoratorInputTransform, "disabled", "disabled", booleanAttribute],
      hideOnClickOutside: [InputFlags.HasDecoratorInputTransform, "hideOnClickOutside", "hideOnClickOutside", booleanAttribute],
      ...
      showIcon: "showIcon",
      hideIcon: "hideIcon",
      rotateAnimation: [InputFlags.HasDecoratorInputTransform, "rotateAnimation", "rotateAnimation", booleanAttribute],
      ariaLabel: "ariaLabel",
