...
var OverlayPanel = class _OverlayPanel {
  ...
  static ɵfac = function OverlayPanel_Factory(t) {
    return new (t || _OverlayPanel)(ɵɵdirectiveInject(DOCUMENT), ɵɵdirectiveInject(PLATFORM_ID), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(PrimeNGConfig), ɵɵdirectiveInject(OverlayService));
  };
  static ɵcmp = ɵɵdefineComponent({
    ...
    inputs: {
      ...
      dismissable: [InputFlags.HasDecoratorInputTransform, "dismissable", "dismissable", booleanAttribute],
...
var OverlayPanelModule = class _OverlayPanelModule {
  static ɵfac = function OverlayPanelModule_Factory(t) {
    return new (t || _OverlayPanelModule)();
  };
