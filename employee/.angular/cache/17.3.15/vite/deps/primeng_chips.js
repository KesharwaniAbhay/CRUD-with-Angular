...
import {
  TimesCircleIcon
} from "./chunk-5GEKRD4K.js";
import {
  TimesIcon
} from "./chunk-ASGWCLQS.js";
import {
  AutoFocus,
  AutoFocusModule
} from "./chunk-MR2QYEAI.js";
import {
  NG_VALUE_ACCESSOR
...
var Chips = class _Chips {
  ...
  static ɵfac = function Chips_Factory(t) {
    return new (t || _Chips)(ɵɵdirectiveInject(DOCUMENT), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(PrimeNGConfig));
  };
  static ɵcmp = ɵɵdefineComponent({
    ...
    inputs: {
      ...
      inputId: "inputId",
      allowDuplicate: [InputFlags.HasDecoratorInputTransform, "allowDuplicate", "allowDuplicate", booleanAttribute],
      caseSensitiveDuplication: [InputFlags.HasDecoratorInputTransform, "caseSensitiveDuplication", "caseSensitiveDuplication", booleanAttribute],
      inputStyle: "inputStyle",
      inputStyleClass: "inputStyleClass",
      addOnTab: [InputFlags.HasDecoratorInputTransform, "addOnTab", "addOnTab", booleanAttribute],
      addOnBlur: [InputFlags.HasDecoratorInputTransform, "addOnBlur", "addOnBlur", booleanAttribute],
      separator: "separator",
